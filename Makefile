...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/09/04 00:29:00 by lmalagon          #+#    #+#              #
#    Updated: 2018/09/04 00:32:35 by lmalagon         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c \
		 	ft_isascii.c ft_isblank.c ft_isdigit.c ft_isprint.c \
		 	ft_isspace.c ft_itoa.c ft_letters.c ft_max.c ft_memcmp.c \
			ft_memalloc.c ft_memccpy.c ft_memchr.c ft_memdel.c \
			ft_memmove.c ft_memset.c ft_putchar.c ft_putchar_fd.c \
		 	...
		 	ft_strtrim.c ft_tolower.c ft_toupper.c ft_words.c \
			ft_memcpy.c ft_strnequ.c ft_lstadd.c ft_lstdel.c \
